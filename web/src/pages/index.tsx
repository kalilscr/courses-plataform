                  ...
                  {blogPosts.map((post) => (
                    <div key={post.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                      <div className="flex-shrink-0">
                        <Image className="h-48 w-full object-cover" src={post.imageUrl} alt="" width={0} height={48} unoptimized quality={50} loading="lazy"/>
                      </div>
                        ...
                        <div className="mt-6 flex items-center">
                          <div className="flex-shrink-0">
                            <Link href={post.author.href}>
                              <Image className="h-10 w-10 rounded-full" src={post.author.imageUrl} alt={post.author.name} width={10} height={10} unoptimized quality={50}/>
                            </Link>
                          </div>
                          <div className="ml-3">
