                  ...
                  <li key={enrollment.id}>
                    <div className="px-4 py-4 flex items-center sm:px-6">
                      ...
                      <div className="ml-5 flex-shrink-0">
                          ...
                          <Link href={`/app/courses/${enrollment.course.slug}`} className="px-2 py-1 border border-transparent text-base font-medium rounded-md text-white bg-violet-600 hover:bg-violet-700">
                            Assistir aulas
                          </Link>
